...
export class Grouper extends ClientFishBase {
  ...
  protected hitBox = { minX: -48, maxX: 45, minY: -42, maxY: 36 };
  ...
  /**
   * Returns positions where the Spanish hogfish / goby can come to inspect/clean
   */
